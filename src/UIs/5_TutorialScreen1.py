...
class GameTutorialScreen(ScreenBase):
    ...
    def draw(self):
        ...
        self.gametext_image_rect = self.gametext_imageResized.get_rect(center = (self.width/5*4, self.height/7*3))
    ...
    gametext_imageResized = pygame.transform.scale(gametext_image, (250,220))
